...
This repository is configured for static export (`output: 'export'`) and deploys using `.github/workflows/deploy.yml`.
...
After that, pushes to `main` trigger deployment via `.github/workflows/deploy.yml`.
